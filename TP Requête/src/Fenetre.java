...
public class Fenetre extends JFrame {
  ...
  */
  public Fenetre(){
    setSize(900, 600);
    setTitle("Testeur de Requêtes JDBC");
  ...
  */
  public void initTable(String query){
    ...
    //On crée un statement
      ...
      Statement state = SingletonConnection.getInstance().createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
      ...
      result.add(new JLabel("La requête à été exécutée en " + totalTime + " ms et a retourné " + rowCount + " ligne(s)"), BorderLayout.SOUTH);
